  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-6 text-center" id="empty-preview-state">
      <div className="relative mb-6">
        ...
        <div className="absolute -bottom-1 -right-1 bg-primary p-1.5 rounded-full border-2 border-[#0A0A0A]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-lg text-left">
        <div className="bg-[#161616]/40 border border-[#262626] p-3.5 rounded-xl flex items-start gap-2.5">
          <span className="bg-[#0A0A0A] text-primary font-mono text-[10px] w-5 h-5 rounded-full flex items-center justify-center font-bold">1</span>
          <div>
            <h4 className="text-[11px] font-bold text-primary uppercase tracking-wider font-mono">Expand Intent</h4>
            <p className="text-[10px] text-slate-400 leading-normal">Categorizes constraints, edge cases, and architectural models.</p>
          </div>
        </div>
        <div className="bg-[#161616]/40 border border-[#262626] p-3.5 rounded-xl flex items-start gap-2.5">
          <span className="bg-[#0A0A0A] text-primary font-mono text-[10px] w-5 h-5 rounded-full flex items-center justify-center font-bold">2</span>
          <div>
            <h4 className="text-[11px] font-bold text-primary uppercase tracking-wider font-mono">Must/Should Criteria</h4>
            <p className="text-[10px] text-slate-400 leading-normal">Defines feature boundaries avoiding downstream scope creep.</p>
          </div>
        </div>
        <div className="bg-[#161616]/40 border border-[#262626] p-3.5 rounded-xl flex items-start gap-2.5">
          <span className="bg-[#0A0A0A] text-primary font-mono text-[10px] w-5 h-5 rounded-full flex items-center justify-center font-bold">3</span>
          <div>
            <h4 className="text-[11px] font-bold text-primary uppercase tracking-wider font-mono">Data & UX Layers</h4>
            <p className="text-[10px] text-slate-400 leading-normal">Assembles clear state loops, animations, and schemas.</p>
          </div>
        </div>
        <div className="bg-[#161616]/40 border border-[#262626] p-3.5 rounded-xl flex items-start gap-2.5">
          <span className="bg-[#0A0A0A] text-primary font-mono text-[10px] w-5 h-5 rounded-full flex items-center justify-center font-bold">4</span>
          <div>
            <h4 className="text-[11px] font-bold text-primary uppercase tracking-wider font-mono">Refined Output</h4>
